    ...
    <div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-1/4 right-[15%] w-40 h-40 rounded-full bg-gdv-gold/10 blur-xl"
        />
      ...
      <section className="py-20 lg:py-28 bg-gdv-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <AnimatedSection>
              <Card className="border-gdv-beige/50 bg-white hover:shadow-xl hover:shadow-gdv-gold/5 transition-all duration-300 overflow-hidden h-full">
                <div className="h-1.5 bg-gradient-to-r from-gdv-gold to-gdv-gold-light" />
                <CardContent className="p-8">
                  <div className="w-14 h-14 rounded-xl bg-gdv-gold/10 flex items-center justify-center text-gdv-gold mb-5">
                    <Target className="w-7 h-7" />
                  </div>
                  <h3 className="text-2xl font-bold text-gdv-brown font-serif mb-4">Notre Mission</h3>
                  <p className="text-gdv-brown/70 leading-relaxed">
            ...
            <AnimatedSection delay={0.15}>
              <Card className="border-gdv-beige/50 bg-white hover:shadow-xl hover:shadow-gdv-gold/5 transition-all duration-300 overflow-hidden h-full">
                <div className="h-1.5 bg-gradient-to-r from-gdv-gold-light to-gdv-gold" />
                <CardContent className="p-8">
                  <div className="w-14 h-14 rounded-xl bg-gdv-gold/10 flex items-center justify-center text-gdv-gold mb-5">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection>
              <div className="text-center mb-12">
                <span className="text-gdv-gold text-sm font-semibold uppercase tracking-widest">Ce qui nous guide</span>
            ...
            >
              {values.map((value: string, index: number) => (
                <motion.div key={value} variants={fadeInUp} custom={index * 0.08}>
                  <div className="px-6 py-3 rounded-full bg-gdv-cream border border-gdv-beige/50 hover:border-gdv-gold/50 hover:bg-gdv-gold/10 transition-all duration-300 cursor-default group">
                    <span className="text-gdv-brown font-medium text-sm sm:text-base group-hover:text-gdv-gold transition-colors flex items-center gap-2">
                      <Heart className="w-4 h-4 text-gdv-gold" />
                      {value}
                    </span>
                  </div>
                </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="text-center mb-10">
              <span className="text-gdv-gold text-sm font-semibold uppercase tracking-widest">Notre Histoire</span>
              <h2 className="text-3xl sm:text-4xl font-bold text-gdv-brown font-serif mt-3">
                Notre Parcours
              </h2>
            </div>
          ...
          <AnimatedSection delay={0.15}>
            <Card className="border-gdv-beige/50 bg-white p-8 sm:p-10 shadow-lg shadow-gdv-brown/5">
              <div className="absolute -top-3 left-10 w-6 h-6 bg-gdv-gold rounded-full" />
              <p className="text-gdv-brown/80 leading-relaxed text-base sm:text-lg font-serif italic">
      ...
      {team && team.length > 0 && (
        <section className="py-20 lg:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection>
              <div className="text-center mb-12">
                <span className="text-gdv-gold text-sm font-semibold uppercase tracking-widest">Notre Équipe</span>
                <h2 className="text-3xl sm:text-4xl font-bold text-gdv-brown font-serif mt-3">
              ...
              {team.slice(0, 4).map((member, index) => (
                <motion.div key={member.id} variants={fadeInUp} custom={index * 0.1}>
                  <div className="text-center group">
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-gdv-gold to-gdv-gold-light mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-gdv-gold/20">
                      {member.name.split(' ').map((n) => n.charAt(0)).join('')}
                    </div>
                    <h4 className="font-semibold text-gdv-brown">{member.name}</h4>
                    <p className="text-gdv-brown/60 text-sm">{member.role}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
